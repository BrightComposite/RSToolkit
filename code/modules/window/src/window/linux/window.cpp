...
namespace asd
{
    ...
    window::~window() {
        ...
        if (_display != nullptr) {                                      // if display was created successfully earlier then
            if (_handle != 0) {                                             // if window handle was created successfully earlier then
                XDestroyWindow(_display, _handle);                              // free window resources and
