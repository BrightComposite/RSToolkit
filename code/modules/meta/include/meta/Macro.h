...
namespace asd
{
	...
	template<class T, class F, class ... A, class R = decltype(declval<F>()(declval<const T>(), declval<A>()...)), class = ptr_guard_t<T>>
	...
	template<class T, class F, class ... A, class R = decltype(declval<F>()(declval<T>(), declval<A>()...)), class = ptr_guard_t<T>>
