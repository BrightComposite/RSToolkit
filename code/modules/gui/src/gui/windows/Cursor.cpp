...
namespace asd
{
	...
	Cursor * Cursor::getPressed(Widget * w, mouse_button button)
	{
	...
	void Cursor::attachPressed(Widget * w, mouse_button button)
	{
	...
	Cursor * PressedCursorComponent::cursor(mouse_button button)
	{
		return _cursors[button];
	}

	void PressedCursorComponent::setCursor(Cursor * cursor, mouse_button button)
	{
