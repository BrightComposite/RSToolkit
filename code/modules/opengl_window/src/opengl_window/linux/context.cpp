...
namespace asd
{
	...
	window_context<opengl::driver>::window_context(opengl::driver & driver, window & w) : base(driver), ::asd::window_context(w) {
		init_device();
	...
	window_context<opengl::driver>::window_context(window_context && ctx) noexcept :
		base(ctx._driver),
		::asd::window_context(std::forward<window_context>(ctx)),
