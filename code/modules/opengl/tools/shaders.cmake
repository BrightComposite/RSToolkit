...
function(shaders_output filename)
    set(TEMPLATE_FILE "${TOOLS_DIR}/templates/embedded.h")
    set(HEADER_FILE   "<opengl/shaders/code.h>")
    set(INCLUDES)
    ...
    foreach(ShaderGroup ${CURRENT_SHADERS_LIST})
        ...
        foreach(ShaderType ${${ShaderGroup}_types})
            if("${ShaderType}" STREQUAL "vs")
                set(SHADER_TYPE GL_VERTEX_SHADER)
            elseif("${ShaderType}" STREQUAL "fs")
                set(SHADER_TYPE GL_FRAGMENT_SHADER)
            elseif("${ShaderType}" STREQUAL "gs")
                set(SHADER_TYPE GL_GEOMETRY_SHADER)
            endif()
        ...
        set(ShaderCodeUnits "\t\t\tstatic const unit shader_code_${ShaderGroup}[] = {${ShaderCodeUnits}};\n")
        ...
        set(ShaderSet "\t\t\t\t{\"${ShaderId}\", {shader_code_${ShaderGroup}, shader_code_${ShaderGroup}_layout}}")
    ...
    collect_files(outfile ${filename})
